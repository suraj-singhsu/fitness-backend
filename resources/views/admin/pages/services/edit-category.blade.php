      ...
      <div class="col-md-12">
         ...
         <div class="panel panel-midnightblue">
            ...
            <div class="panel-body no-padding">
               ...
               <option value="{{ $cat->id }}" {{($categoryInfo != null && $cat->id == $categoryInfo->parent_id)  ? 'selected' : ''}}>({{$cat->id}}) - {{$cat->name}}</option>
                           @endforeach
                        </select>
                  </div>
                  ...
                  <div class="col-sm-4">
                     ...
                     <input type="text" name="name" id="name" class="form-control" placeholder="Enter Category Name" value="{{($categoryInfo != null && $categoryInfo->name) ? $categoryInfo->name : ''}}" required>
                  </div>
