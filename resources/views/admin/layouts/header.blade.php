	...
	<ul class="nav navbar-nav toolbar pull-right">
				...
				<div class="scroll-pane">
					<ul class="media-list scroll-content">
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="{{asset('admin-assets/demo/avatar/avatar_01.png')}}" alt="" />
								</div>
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="{{asset('admin-assets/demo/avatar/avatar_09.png')}}" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="{{asset('admin-assets/demo/avatar/avatar_02.png')}}" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="{{asset('admin-assets/demo/avatar/avatar_03.png')}}" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="{{asset('admin-assets/demo/avatar/avatar_04.png')}}" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="{{asset('admin-assets/demo/avatar/avatar_05.png')}}" alt="" />
								</div>
								<div class="media-body">
						...
						<li class="media notification-message">
							<a href="#">
								<div class="media-left">
									<img class="img-circle avatar" src="{{asset('admin-assets/demo/avatar/avatar_06.png')}}" alt="" />
								</div>
								<div class="media-body">
		...
		<li class="dropdown toolbar-icon-bg">
			<a href="#" class="dropdown-toggle username" data-toggle="dropdown">
				<img class="img-circle" src="{{asset('admin-assets/demo/avatar/avatar_15.png')}}" alt="" />
			</a>
			<ul class="dropdown-menu userinfo arrow">
				<li><a href="{{url('admin/my-profile')}}"><i class="ti ti-user"></i><span>My Profile</span><span class="badge badge-info pull-right">80%</span></a></li>
				<li><a href="{{url('admin/change-password')}}"><i class="ti ti-panel"></i><span>Change Password</span></a></li>
