<div class="demo-options">
    ...
    <div class="demo-heading">Sutech Theme Settings</div>
    <div class="demo-body pt-n pb-n">
        <div class="option-title m-n p-n" >TopBar</div>
    ...
    <div class="demo-body pb-n">
        <div class="option-title m-n p-n">Sidebar</div>
